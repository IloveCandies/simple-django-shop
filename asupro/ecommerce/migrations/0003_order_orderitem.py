...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('ecommerce', '0002_alter_cart_id_alter_cartitem_id_alter_promocode_id'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='order_items', to='maincontent.product')),
            ],
        ),
    ]
